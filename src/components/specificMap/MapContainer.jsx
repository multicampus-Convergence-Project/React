...
const MapContainer = (props) => {
  useEffect(() => {
    ...
    const customDisplayMarker = () => {
      ...
      // 마커 이미지의 이미지 주소입니다
      var imageSrcYellow =
        'https://user-images.githubusercontent.com/69428620/102439510-bbb2e180-4061-11eb-8d58-b40ece0073b3.png';
      var imageSrcRed =
        'https://user-images.githubusercontent.com/69428620/102439516-bd7ca500-4061-11eb-95db-75aa538f6a67.png';
      var imageSrcGreen =
        'https://user-images.githubusercontent.com/69428620/102439506-bb1a4b00-4061-11eb-8a01-301a1c595192.png';

      // // 지도 중심좌표를 접속위치로 변경합니다
      map.setCenter(
        new kakao.maps.LatLng(props.stateData[2], props.stateData[3])
      );
      ...
      function makeMarker(selectedLocation) {
        ...
        // 마커 이미지를 생성합니다
        var markerImageYellow = new kakao.maps.MarkerImage(
          imageSrcYellow,
          imageSize
        );
        var markerImageRed = new kakao.maps.MarkerImage(imageSrcRed, imageSize);
        var markerImageGreen = new kakao.maps.MarkerImage(
          imageSrcGreen,
          imageSize
        );

        var position = new kakao.maps.LatLng(
          selectedLocation.stationLatitude,
          selectedLocation.stationLongitude
        );
        ...
        var content =
          ...
          '           </div>' +
          '            <div class="desc">' +
          '                <div class="ellipsis">현재 사용가능:' +
          selectedLocation.parkingBikeTotCnt +
          '대/' +
          selectedLocation.rackTotCnt +
          '대</div>' +
          '                <div class="jibun ellipsis">거치율: ' +
          selectedLocation.shared +
          '(%)</div>' +
          '                <div>StationId: ' +
